...
# FeedHenry
JAVA_OPTS="-Xmx512m -Dfeedhenry.node=node02 -Dfh.cluster.override=/etc/feedhenry/cluster-override.properties"
...
if [ -z "$CATALINA_OUT" ] ; then
  CATALINA_OUT=/log/tomcat/release/node02/catalina.out
fi
