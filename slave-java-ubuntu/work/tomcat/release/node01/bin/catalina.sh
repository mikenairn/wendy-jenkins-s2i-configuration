...
# FeedHenry
JAVA_OPTS="-Xmx512m -Dfeedhenry.node=node01 -Dfh.cluster.override=/etc/feedhenry/cluster-override.properties"
...
if [ -z "$CATALINA_OUT" ] ; then
  CATALINA_OUT=/log/tomcat/release/node01/catalina.out
fi
...
echo "Removing contents of temp directory $CATALINA_TMPDIR"
